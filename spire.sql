...
ALTER TABLE `projects`
  ...
  ADD CONSTRAINT `fk_p_inquiry_id` FOREIGN KEY (`inquiry_id`) REFERENCES `inquiries` (`id`),
  ADD CONSTRAINT `fk_p_invoice_firm_id` FOREIGN KEY (`invoice_firm_id`) REFERENCES `owner_firms` (`id`),
