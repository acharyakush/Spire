...
(15, 1, 3, 'OFEX', 'AC03', 'BK03', 500.00, 'dbsjdhb', 'DC', 'Professional Fees', 'jdshbjsdf', '2025-02-06 19:23:35', 'A3'),
(16, 1, 3, 'OFEX', 'AC01', 'BK01', 125.00, 'nnn', 'NETBANKING', 'Professional Fees', 'lll', '2025-02-07 14:30:09', 'A3'),
(17, 1, 4, 'OFEX', 'AC04', 'BK04', 25000.00, 'ccc', 'CHEQUE', 'Professional Fees', 'bbbb', '2025-02-07 14:31:13', 'A3'),
(18, 2, 5, 'OFEX', 'AC02', 'BK02', 55.00, 'cvcvb', 'UPI', 'Reimbursement Voucher', 'deweqe', '2025-02-07 14:32:24', 'A3'),
(19, 1, 8, 'OFEX', 'AC03', 'BK03', 10.00, 'ppp', 'NETBANKING', 'Reimbursement Voucher', 'aaa', '2025-02-07 15:03:13', 'A3');
...
('CN000005', 'AF000001', 'CP000002', 'RF000005', 'Dipen Soni', NULL, 9998733006, 'change@gmail.com', 1, 0, '2025-01-12 11:18:02', NULL, 0, '2025-01-12 11:18:02', NULL),
...
('CP000001', 'CN000001', 'Sun Pharma Pvt Ltd', '07925462408', 'support@sunpharma.com', NULL, 'BBXPA8126Q', NULL, NULL, 500.00, 500.00, '2024-12-17 23:48:41', 'A3'),
...
INSERT INTO `petty_cash_transactions` (`id`, `owner_firm_id`, `owner_firm_bank_id`, `amount_paid`, `amount_received`, `particulars`, `payment_source`, `payment_type`, `remarks`, `entry_at`, `entry_by_id`) VALUES
(1, 'AC03', 'BK03', 8500.00, 0.00, 'uio', 'NETBANKING', 'Professional Fees', 'bnm', '2025-02-07 16:54:57', 'A3'),
(2, 'AC04', 'BK04', 0.00, 125.00, 'mm', 'CHEQUE', 'Reimbursement Voucher', 'bb', '2025-02-07 17:00:18', 'A3');
...
ALTER TABLE `affiliates_transactions`
  ...
  ADD KEY `fk_aph_owner_firms_bank_id` (`owner_firms_banks_id`),
...
ALTER TABLE `invoices_payment_history`
  ADD PRIMARY KEY (`id`),
  ADD KEY `iph_project_id` (`project_id`);
...
ALTER TABLE `reimburse_voucher_transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `rvt_project_id` (`project_id`);
...
ALTER TABLE `tasks_particulars_remarks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_tpr_task_id` (`task_id`),
  ADD KEY `fk_tpr_project_id` (`project_id`);
...
ALTER TABLE `companies`
  ADD CONSTRAINT `fk_company_client_id` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `projects`
  ADD CONSTRAINT `fk_projects_client_id` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`),
  ADD CONSTRAINT `fk_projects_company_id` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`),
  ADD CONSTRAINT `fk_projects_inquiry_id` FOREIGN KEY (`inquiry_id`) REFERENCES `inquiries` (`id`),
  ADD CONSTRAINT `fk_projects_invoice_firm_id` FOREIGN KEY (`invoice_firm_id`) REFERENCES `owner_firms` (`id`),
  ADD CONSTRAINT `fk_projects_main_project_id` FOREIGN KEY (`main_project_id`) REFERENCES `main_projects` (`id`),
  ADD CONSTRAINT `fk_projects_sub_project_id` FOREIGN KEY (`sub_project_id`) REFERENCES `sub_projects` (`id`);
...
ALTER TABLE `tasks_particulars_remarks`
  ADD CONSTRAINT `fk_td_project_id` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`),
  ADD CONSTRAINT `fk_td_task_id` FOREIGN KEY (`task_id`) REFERENCES `tasks` (`id`);
