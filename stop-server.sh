...
# Find all PIDs of processes running "node /home/fco1t1x9fsye/public_html/crm.signiixadvisors.com/server.js"
# -f option in pgrep allows searching the entire command line
PIDS=$(pgrep -f "node /home/fco1t1x9fsye/public_html/crm.signiixadvisors.com/server.js")
