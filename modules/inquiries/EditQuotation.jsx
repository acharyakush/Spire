...
export default function EditQuotation({ clients, inquiry, reload, unmount }) {
	...
	async function getSupportData() {
		try {
			...
			const result = await axios.get(ApiEndpoints.Inquiries.GetEditQuotationSupport, MyGlobal.GetHeaders());
	...
	// Main UI
	if (main.openPreview) {
		return <EditQuotaionPreview inquiry={inquiry} quotation={{ client, firm, main, services, proposalNumber: firm.proposalNumber }} reload={unmountAndReloadRoot} unmount={togglePreview} />;
	}
