...
export default async function handler(req, res) {
	...
	try {
		...
		const response = await query("INSERT INTO rv_transactions (rv_custom_id, project_id, entry_at, particulars, amount, source) VALUES (?, ?, ?, ?, ?, ?)", [customId, projectId, entryAt, particulars, amount, source]);
