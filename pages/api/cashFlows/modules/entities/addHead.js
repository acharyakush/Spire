...
export default async function handler(req, res) {
	...
	try {
		...
		const result = await query("INSERT INTO cash_flows_heads (entity_id, module_id, firm_id, bank_id, amount, payment_source, purpose, remarks, entry_at, entry_by_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", [entityId, moduleId, firmId, bankId, amount, paymentSource, purpose, remarks, entryAt, userId]);
