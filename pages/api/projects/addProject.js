...
export default async function handler(req, res) {
	...
	try {
		const { clientId, company, financialYear, remarks, inquiryId, invoiceFees, invoiceFirm, mainProject, note, quote, subProject, teams, userId } = req.body;
